  ...
  return <>
    ...
    <div className="col-md-12 col-lg-12" style={{textAlign: "center"}}>
      ...
      <div className={css.event}>
        ...
        <div className={css.date}>Sunday, May 4th | 3-5:30 PM (doors at 3pm, program at 3:30 sharp)</div>
        <div className={css.location}>Grace Church Van Vorst, 39 Erie St (entrance on 2nd St), Jersey City</div>
        <div className={css.sub}><A href={""}>Reserve seating here</A></div>
        <div className={css.sub}><A href={""}>Submit questions here</A>; we will draw upon these for the Q&A session</div>
        ...
        <div>
          Margaret Schmidt, former editor of The Jersey Journal, will moderate a question-and-answer session.  A reception will follow the program.
        </div>
      </div>
      <div className={css.event}>
        <H5 id={"bot-walk"}>Children’s Botanical Nature Walk</H5>
        <div className={css.date}>Saturday, May 17th | 11am</div>
        <div><A href={"https://docs.google.com/forms/d/e/1FAIpQLSdAo6MfQFEiCvu_KiHP4u10-BdfzFX5SGQQ6ue4TDGZZgHMEQ/viewform"}>Register here</A></div>
