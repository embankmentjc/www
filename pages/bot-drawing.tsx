                ...
                <div className="container">
                    <div className="row justify-content-center offset-top-20">
                        ...
                        <div className="col-md-9 col-lg-7 text-md-left offset-top-34 offset-lg-top-0">
                            ...
                            <p><a href="https://docs.google.com/document/d/12qGTwQu8OqjMHVf_bSARFIZ5HKHPqCEg/edit?usp=sharing&ouid=113315672036581348329&rtpof=true&sd=true"><strong>Detailed Description of Course</strong></a> - Includes topics covered in each class.</p>
                            <p><a href="https://docs.google.com/document/d/1q-c21AsZKICgNmbHS3FKqCa4u_bi4Wth/edit?usp=sharing&ouid=113315672036581348329&rtpof=true&sd=true"><strong>Materials List</strong></a> - Recommends materials for participants, noting the bare minimum,and provides estimated prices and places from which these can be obtained.</p>
