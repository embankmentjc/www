                        ...
                        <div className="col-md-9 col-lg-7 text-md-left offset-top-34 offset-lg-top-0">
                            ...
                            <div className="row offset-top-20">
                                ...
                                <p>
                                    ...
                                    {' '}<a href="https://paulchingbor.com/">Paul Ching-Bor</a>,
                                    {' '}<a href="https://nancymcohen.com/">Nancy Cohen</a>,
                                    {' '}<a href="https://www.santiagocohen.com/">Santiago Cohen</a>,
                                    {' '}<a href="https://instagram.com/kimcorrero">Kim Correro</a>,
                                    {' '}<a href="https://www.bethdary.com/">Beth Dary</a>,
                                    {' '}<a href="https://www.katedodd.com/">Kate Dodd</a>,
                                    ...
                                    {' '}<a href="https://www.novadogallery.com/gallery-artists#/anne-novado">Anne Novado</a>,
                                    {' '}<a href="https://www.williamaortega.com/">William Ortega</a>,
                                    ...
                                    {' '}<a href="https://www.lstreicher.com/home">Linda Streicher</a>,
