                    ...
                    <div className="row justify-content-sm-center offset-top-66">
                        <div className="col-md-8 col-lg-4">
                            ...
                            <div className="unit unit-sm flex-md-row text-md-left">
                                <div className="unit-left"><span className="icon novi-icon icon mdi mdi-city icon-mantis-filled icon-circle" /></div>
                        ...
                        <div className="col-md-8 col-lg-4 offset-top-66 offset-lg-top-0">
                            {/* Icon Box Type 2 */}
                            <div className="unit unit-sm flex-md-row text-md-left">
                                <div className="unit-left"><span className="icon novi-icon icon mdi mdi-recycle icon-mantis-filled icon-circle" /></div>
                                <div className="unit-body">
                        ...
                        <div className="col-md-8 col-lg-4 offset-top-66 offset-lg-top-0">
                            {/* Icon Box Type 2 */}
                            <div className="unit unit-sm flex-md-row text-md-left">
                                <div className="unit-left"><span className="icon novi-icon icon mdi mdi-share-variant icon-mantis-filled icon-circle" /></div>
                                <div className="unit-body">
