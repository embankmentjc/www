...
function SponsorsList({ title, sponsors }: { title: string, sponsors: ({ alt: string, src: string, href: string }[])}) {
    return (<>
                ...
                <div className="row">
                    {
                        sponsors.map(
                            ({ alt, src, href }) =>
                                <a href={href} target="_blank"><img className="" alt={alt} src={src} width="150" height="70" /></a>
                        )
                    }
                </div>
            </div>
        ...
        >
                ...
                <SponsorsList
                    ...
                    sponsors={[
                        ...
                        { alt: "Skinner's Loft", src: "/images/sponsors/SKINNER2_LOGO.png", href: "https://www.skinnersloft.com/", },
                        ...
                        { alt: "Warren G Curtin Realty", src: "/images/sponsors/WARREN_LOGO.jpg", href: "http://www.wgcrealty.com/team/9b459cb0-7fb9-4260-860a-9e2a3cc2c08a/21704/18", },
                    ]}
                />
                <SponsorsList
                    title={"Silver Level"}
                    sponsors={[
                        { alt: "PostNet", src: "images/sponsors/POST_LOGO.png", href: "https://locations.postnet.com/nj/jersey-city/344-grove-st", },
                        { alt: "Delenio", src: "images/sponsors/DELENIO_LOGO.png", href: "https://www.deleniojc.com/", },
                        { alt: "Carmine's Pizza", src: "images/sponsors/CARMINE_LOGO.png", href: "https://www.mycarminespizza.com/", },
                        { alt: "Newport Pharmacy", src: "images/sponsors/NEWPORT_LOGO.png", href: "https://goo.gl/maps/W6dWQvseMSkuXo3HA", },
                        { alt: "Mastrolia Pharmacy", src: "images/sponsors/MASTROLIA_LOGO.jpg", href: "https://goo.gl/maps/wR2UT9jEn2NC2Ffp6", },
                    ]}
                />
        </Section>
    )
...
export default function Body() {
    return (
        ...
        >
            ...
            {/* Section Donate  */}
            <section id="involved-section-donate" className="section section-50 section-top-124 section-bottom-110">
                <div className="container">
